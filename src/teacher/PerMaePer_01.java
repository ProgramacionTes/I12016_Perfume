 ...
 * @author prof_tes_a
 */
public class PerMaePer_01 extends javax.swing.JDialog
{
    ...
    /**
     * Creates new form PerMaePer_01
     */
    public PerMaePer_01(java.awt.Frame parent, boolean modal)
    {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PerMaePer_01.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PerMaePer_01 dialog = new PerMaePer_01(new javax.swing.JFrame(), true);
    ...
    private boolean cargarMarcas()
    {
        ...
        try
        {
            java.io.FileReader objFilRea=new java.io.FileReader("PerMarcas.txt");
    ...
    private boolean cargarImagenesMarcas()
    {
        ...
        try
        {
            java.io.FileReader objFilRea=new java.io.FileReader("PerImagenesMarcas.txt");
            java.io.BufferedReader objBufRea=new java.io.BufferedReader(objFilRea);
            String strLin;
